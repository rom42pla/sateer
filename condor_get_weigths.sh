...
shared_params="--seed=42 --checkpoints_path=./checkpoints/weights --validation=simple --batch_size=1024 --windows_size=2 --windows_stride=1"
base_model_params=""
small_model_params="--num_encoders=2 --num_decoders=2"
...
deap_command $base_model_params --model_name="eegst_deap_base"
$deap_command $small_model_params --model_name="eegst_deap_small"
...
$dreamer_command $base_model_params --model_name="eegst_dreamer_base"
$dreamer_command $small_model_params --model_name="eegst_dreamer_small"
...
$seed_command $base_model_params --model_name="eegst_seed_base"
$seed_command $small_model_params --model_name="eegst_seed_small"
...
$amigos_command $base_model_params --model_name="eegst_amigos_base"
$amigos_command $small_model_params --model_name="eegst_amigos_small"