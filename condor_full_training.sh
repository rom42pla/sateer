...
$deap_command --batch_size=2048 --windows_size=1 --windows_stride=1
$deap_command --batch_size=2048 --windows_size=2 --windows_stride=1
...
$amigos_command --batch_size=2048 --windows_size=1 --windows_stride=1
$amigos_command --batch_size=2048 --windows_size=2 --windows_stride=2
