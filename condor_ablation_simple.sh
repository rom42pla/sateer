...
arguments = $(pwd)/ablation_simple.py --dataset_type=$dataset --dataset_path=data/$dataset --checkpoints_path=./checkpoints --batch_size=256 --windows_size=10 --windows_stride=2 --seed=42
