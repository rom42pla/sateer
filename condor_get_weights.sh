...
$deap_command --batch_size=1024 --windows_size=2 --windows_stride=1 --hidden_size=256 --num_encoders=1 --num_decoders=1 --num_attention_heads=4 --model_name="eegst_deap_small"
...
$dreamer_command --batch_size=1024 --windows_size=2 --windows_stride=1 --hidden_size=256 --num_encoders=1 --num_decoders=1 --num_attention_heads=4 --model_name="eegst_dreamer_small"
...
$seed_command --batch_size=1024 --windows_size=2 --windows_stride=1 --hidden_size=256 --num_encoders=1 --num_decoders=1 --num_attention_heads=4 --model_name="eegst_seed_small"
...
$amigos_command --batch_size=1024 --windows_size=2 --windows_stride=1 --hidden_size=256 --num_encoders=1 --num_decoders=1 --num_attention_heads=4 --model_name="eegst_amigos_small"